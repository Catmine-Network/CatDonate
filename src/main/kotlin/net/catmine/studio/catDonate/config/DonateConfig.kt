...
data class DonateConfig(
    ...
    val pollIntervalIncrement: Duration,
    ...
    companion object {
        fun load(config: FileConfiguration): DonateConfig {
            ...
            return DonateConfig(
                ...
                pollInterval = Duration.ofSeconds(positive("polling.interval-seconds", 15).toLong()),
                pollIntervalIncrement = Duration.ofSeconds(positive("polling.interval-increment-seconds", 5).toLong()),
